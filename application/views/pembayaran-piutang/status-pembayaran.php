                                        ...
                                        <?php foreach ($pembayaran_piutang as $p): ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="<?php echo base_url('pembayaran-piutang/edit/' . $p->id_pembayaran_piutang); ?>" class="btn btn-light">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    <a href="#" class="btn btn-light" onclick="showConfirmDelete('pembayaran-piutang', <?php echo $p->id_pembayaran_piutang; ?>)">
